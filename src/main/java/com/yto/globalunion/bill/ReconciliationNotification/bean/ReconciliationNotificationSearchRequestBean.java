/*
 * 项目名: 全球大联盟
 * 文件名: ReconciliationNotificationSearchRequestBean.java
 *
 * 版权声明:
...
public class ReconciliationNotificationSearchRequestBean extends RequestBaseBean implements IMultiLanguageable {
